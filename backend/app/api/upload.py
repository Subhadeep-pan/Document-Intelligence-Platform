...
from backend.app.services.docx_service import extract_text_from_docx
from backend.app.services.txt_service import extract_text_from_txt
...
from backend.app.services.chroma_service import store_chunks
...
async def upload_files(
    ...
    os.makedirs("backend/uploads/pdfs", exist_ok=True)  # ← add this
